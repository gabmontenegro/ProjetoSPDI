% Seleciona a posicao de 4 amostras aleatórias da lista de matches
function [am1 am2] = ransac_sample(corr_req, M0, M1, T)
    ...
    while (teste == 0) && (it < 500)
        ...
        % Escolhendo as correspondências (posições)
        ...
        % Verifica se pontos são colineares
        ...
        % Verifica desvio angular de cada ponto, até 5 graus
